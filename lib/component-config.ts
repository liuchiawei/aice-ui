  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        labelKey: "pixelated-canvas.label",
        descriptionKey: "pixelated-canvas.description",
        demo: PixelatedCanvasDemo,
        sourceCode: pixelatedCanvasSource,
        date: "2026-02-25",
        usageProps: [
          { name: "src", type: "string", descriptionKey: "pixelated-canvas.props.src" },
          { name: "width", type: "number", default: "400", descriptionKey: "pixelated-canvas.props.width" },
          { name: "height", type: "number", default: "500", descriptionKey: "pixelated-canvas.props.height" },
          { name: "variant", type: "\"static\" | \"interactive\"", descriptionKey: "pixelated-canvas.props.variant" },
          { name: "cellSize", type: "number", default: "3", descriptionKey: "pixelated-canvas.props.cellSize" },
          { name: "dotScale", type: "number", default: "0.9", descriptionKey: "pixelated-canvas.props.dotScale" },
          { name: "shape", type: "\"circle\" | \"square\"", default: "\"square\"", descriptionKey: "pixelated-canvas.props.shape" },
          { name: "backgroundColor", type: "string", default: "\"#000000\"", descriptionKey: "pixelated-canvas.props.backgroundColor" },
          { name: "grayscale", type: "boolean", default: "false", descriptionKey: "pixelated-canvas.props.grayscale" },
          { name: "className", type: "string", descriptionKey: "pixelated-canvas.props.className" },
          { name: "responsive", type: "boolean", default: "false", descriptionKey: "pixelated-canvas.props.responsive" },
          { name: "dropoutStrength", type: "number", default: "0.4", descriptionKey: "pixelated-canvas.props.dropoutStrength" },
          { name: "interactive", type: "boolean", default: "true", descriptionKey: "pixelated-canvas.props.interactive" },
          { name: "distortionStrength", type: "number", default: "3", descriptionKey: "pixelated-canvas.props.distortionStrength" },
          { name: "distortionRadius", type: "number", default: "80", descriptionKey: "pixelated-canvas.props.distortionRadius" },
          { name: "distortionMode", type: "\"repel\" | \"attract\" | \"swirl\"", default: "\"swirl\"", descriptionKey: "pixelated-canvas.props.distortionMode" },
          { name: "followSpeed", type: "number", default: "0.2", descriptionKey: "pixelated-canvas.props.followSpeed" },
          { name: "sampleAverage", type: "boolean", default: "true", descriptionKey: "pixelated-canvas.props.sampleAverage" },
          { name: "tintColor", type: "string", default: "\"#FFFFFF\"", descriptionKey: "pixelated-canvas.props.tintColor" },
          { name: "tintStrength", type: "number", default: "0.2", descriptionKey: "pixelated-canvas.props.tintStrength" },
          { name: "maxFps", type: "number", default: "60", descriptionKey: "pixelated-canvas.props.maxFps" },
          { name: "objectFit", type: "\"cover\" | \"contain\" | \"fill\" | \"none\"", default: "\"cover\"", descriptionKey: "pixelated-canvas.props.objectFit" },
          { name: "jitterStrength", type: "number", default: "4", descriptionKey: "pixelated-canvas.props.jitterStrength" },
