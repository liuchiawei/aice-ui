...
| 元件 | 說明 |
|------|------|
| **可拖拽網格** | 可拖曳的 2D 網格，圖示格具視差效果。靈感來自 Apple WatchOS。（2026-02-20） |
| **時間軸** | 左側固定年份、右側卡片內容的垂直時間軸。可選捲動驅動軸線填充效果。（2026-02-20） |

### 導航

| 元件 | 說明 |
|------|------|
| **放射式選單** | 點擊後以放射狀展開的動作選單。複合元件：Root、Trigger、Item。可設定展開角度與方向。（2026-02-21） |
| **浮動導航列** | 滑鼠懸停放大圖示的底部導航列。桌面版固定於底部，手機版收合為選單按鈕。（2026-02-24） |
