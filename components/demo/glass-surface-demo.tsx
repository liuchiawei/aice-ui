...
function GlassSurfaceDemo() {
  return (
    <div className="h-full w-full p-12 flex justify-center items-center text-white bg-[url('https://picsum.photos/800/600')] bg-cover bg-center">
      <GlassSurface width={180} height={60} borderRadius={16} contentClassName="group flex items-center justify-center gap-4">
